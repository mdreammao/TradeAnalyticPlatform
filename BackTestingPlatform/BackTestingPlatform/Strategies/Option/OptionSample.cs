...
namespace BackTestingPlatform.Strategies.Option
{
    ...
    //        List<OptionMinuteKLineWithUnderlying> answer = new List<OptionMinuteKLineWithUnderlying>();
    ...
    //    public void saveToLocalFile(List<OptionMinuteKLineWithUnderlying> optionMinuteData, string path)
    //    {
    ...
    //    public List<OptionMinuteKLineWithUnderlying> AddEtfPrice(List<OptionMinuteKLine> option, List<KLine> etf, OptionInfo optionInfo)
    //    {
