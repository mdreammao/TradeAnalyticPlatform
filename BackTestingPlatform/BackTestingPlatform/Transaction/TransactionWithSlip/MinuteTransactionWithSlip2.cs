...
namespace BackTestingPlatform.Transaction.TransactionWithSlip
{
    ...
    {
        public static DateTime computeMinutePositions2(Dictionary<string, MinuteSignal> signal, Dictionary<string, List<KLine>> data, ref SortedDictionary<DateTime, Dictionary<string, MinutePositions>> positions, ref BasicAccount myAccount, DateTime now, double slipPoint = 0.003)
        {
